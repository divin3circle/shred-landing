"use client";
import { AppleIcon, CommandIcon, CornerDownLeft } from "lucide-react";
    ...
    <div className="mt-10 flex items-center justify-center w-full px-2 z-50">
      <div className="w-[90%] md:max-w-2xl rounded-4xl border border-gray-500 py-2 flex items-center justify-between">
        <div className="flex items-center px-4">
          <AppleIcon className="size-6 text-gray-500" />
          <input
            type="text"
            placeholder="Search for applications..."
            className="bg-white text-gray-500 font-sans placeholder-gray-500 rounded-full px-4 py-2 focus:outline-none focus:ring-0 border-0"
            value={query}
